...
var SheetCommentsWriter = module.exports = function (worksheet, sheetRelsWriter, options) {
...
SheetCommentsWriter.prototype = {
  ...
  _addRelationships: function _addRelationships() {
    var commentRel = {
  ...
  _addCommentRefs: function _addCommentRefs() {
  ...
  _writeComment: function _writeComment(comment, index) {
